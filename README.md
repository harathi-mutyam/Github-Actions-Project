...
copy the Set up Docker's apt repository commands from browser , paste and run in 

runnerinstalationpurpose gitbash terminal
...
terraform --version
These are the Terraform installation steps documented in my project notes.
...
After the GitHub Actions pipeline completes successfully, open the Server Git Bash terminal.
Run:
kubectl get all
